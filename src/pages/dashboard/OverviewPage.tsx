...
const OverviewTab: React.FC = React.memo(() => {
  ...
  const { data: quotationsList, refetch: refetchQuotations } = useQuotationsList({
    page,
    page_size: pageSize,
    status: statusFilter ? String(statusFilter).toUpperCase() : undefined,
    search: searchQuery,
  ...
  }, [processingNew, stopProcessingNew, clearProcessingBaseline]);
